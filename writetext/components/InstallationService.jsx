    ...
    <ModalPrompt target="installation" ></ModalPrompt>
        ...
        <div>
            <div className="header">
                <p className='installation-info'>{translation["PageSubHeaderText"].replaceAll('{textAmountDisplay}',userData.allBilling.installationPlan.currency + ' ' + userData.allBilling.installationPlan.amount).replace('{textAmountDisplayMultiplied}', userData.allBilling.installationPlan.currency + ' ' + userData.allBilling.installationPlan.amount * 2)}</p>
