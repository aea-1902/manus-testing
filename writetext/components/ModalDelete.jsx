            ...
            <div className="modal-content">
              ...
              <div className="modal-body">
                ...
                <div className="mb-20">
                  ...
                  <p className="modal-text">Removing access to webshops will take effect up to 24 hours. If you need to immediately revoke access for the key, delete it instead.</p>
                  </div>
                <div className="right">
